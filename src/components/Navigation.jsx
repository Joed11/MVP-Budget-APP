...
var Navigation = (props) => {
  ...
  const [selectedChart, setSelectedChart] = useState(props.defaultChart);
    ...
    <div className="nav-container">
      <div className="navigation-container">
        ...
        <button
          ...
          onClick={() => getCharts(props.username.toLowerCase(), props.updateSavedCharts.bind(this))}>
          GET MY CHARTS
        </button>
        ...
        <input
          className="input-nav-input"
          type='number'
          onChange={(e)=> props.updateAssets(e.target.value)}
          value={props.assets}>
        </input>
        <p className="input-nav-label">My Charts</p>
        <select
          className="input-nav-input nav-charts"
          onChange={(e) => {
      ...
      <input
        className="input-nav-chartName"
        type='test'
        onChange={(e)=> setChartName(e.target.value)} value={chartName}>
      </input>
      <button
        className="input-nav-save-button"
        onClick={()=> {
            saveChart(props.username.toLowerCase(), chartName.toLowerCase(), props.assets, props.labels, props.dataPoints, props.categories, props.savedCharts, props.updateSavedCharts.bind(this))
          }
      }>SAVE CHART</button>
    </div>
  )
